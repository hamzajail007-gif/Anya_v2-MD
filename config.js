...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Hamza Hacker",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 Hamza Hacker",
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "Hamza Hacker",
    ownernumber: process.env.Owner_Number || "92339 6386670",
    instagramId: process.env.Insta || " .",

    /**
     * other details and parameters
     */
    author: process.env.Author || "Hamza bots🌚🌙",
    packname: process.env.PackName || "The Hamza Hacker.🪀",
